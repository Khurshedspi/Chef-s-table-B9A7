            ...
            <div className="card-body">
              ...
              <ul className="ml-8">
                {recipe.ingredients.map((item, idx) => (
                  <li className="list-disc text-gray-500" key={idx}>
                    {item}
                  </li>
                ))}
              </ul>
              ...
              <div className="card-actions">
                <button onClick={()=>addRecipeToQueue(recipe)} className="btn bg-green-400 rounded-full px-8 text-xl text-gray-800 font-medium">Want To Cook</button>
              </div>
            </div>
          </div>
        ))}
